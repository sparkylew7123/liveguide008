-- Direct seeding script for dev database
-- Handles the specific schema differences
...
('a6c2193a-fbed-4e35-97a9-c14f7caeb597', 'Scale SparkyTek to $10M ARR', 'Grow from $2M to $10M through product expansion', 'active', 'career', '2025-12-31', '{"priority": "high", "progress": 20}'::jsonb),
('a6c2193a-fbed-4e35-97a9-c14f7caeb597', 'Launch AI Coaching Platform', 'Release LiveGuide with 1000 active users', 'active', 'career', '2025-06-30', '{"priority": "high", "progress": 65}'::jsonb),
('a6c2193a-fbed-4e35-97a9-c14f7caeb597', 'Master LLM Fine-tuning', 'Become proficient in fine-tuning LLMs', 'active', 'career', '2025-04-30', '{"priority": "medium", "progress": 40}'::jsonb),
('a6c2193a-fbed-4e35-97a9-c14f7caeb597', 'Maintain Work-Life Balance', 'Quality time with family', 'active', 'wellbeing', '2025-12-31', '{"priority": "high", "progress": 60}'::jsonb),
('a6c2193a-fbed-4e35-97a9-c14f7caeb597', 'Complete Marathon', 'Train for SF Marathon', 'active', 'health', '2025-10-15', '{"priority": "medium", "progress": 25}'::jsonb),
('a6c2193a-fbed-4e35-97a9-c14f7caeb597', 'Daily Meditation', 'Establish consistent practice', 'active', 'Mindfulness', '2025-02-28', '{"priority": "medium", "progress": 80}'::jsonb);

-- Create graph nodes
INSERT INTO graph_nodes (user_id, node_type, label, description, properties, status) VALUES
-- Goals
('a6c2193a-fbed-4e35-97a9-c14f7caeb597', 'goal', 'Scale to $10M ARR', 'Grow SparkyTek revenue 5x', '{"category": "Business", "priority": "high", "progress": 20}'::jsonb, 'curated'),

-- Complete seeding script for dev database with all correct column names
...
-- Add voice events with correct column names (event_data instead of data, no timestamp column)
INSERT INTO voice_chat_events (user_id, conversation_id, event_type, event_data, created_at) VALUES
('907f679d-b36a-42a8-8b60-ce0d9cc11726', gen_random_uuid()::text, 'session_start', '{"agent": "Strategic Coach", "topic": "Q1 Planning"}'::jsonb, NOW() - INTERVAL '2 hours'),
('907f679d-b36a-42a8-8b60-ce0d9cc11726', gen_random_uuid()::text, 'insight_captured', '{"insight": "Focus on retention over acquisition", "confidence": 0.92}'::jsonb, NOW() - INTERVAL '1 hour 45 minutes'),
('907f679d-b36a-42a8-8b60-ce0d9cc11726', gen_random_uuid()::text, 'emotion_detected', '{"emotion": "determination", "intensity": 0.85}'::jsonb, NOW() - INTERVAL '1 hour 30 minutes');
